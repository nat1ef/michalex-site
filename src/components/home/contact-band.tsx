      ...
      <div className="section-shell flex flex-col gap-6 py-16 lg:mx-0 lg:max-w-none lg:py-20 lg:pl-[max(3rem,calc((100vw-80rem)/2+3rem))] lg:pr-14">
        <Reveal>
          ...
          <a
            ...
            className="display-num mt-6 block w-fit text-[clamp(2.1rem,4.4vw,3.2rem)] text-band-foreground transition-colors hover:text-accent-bright"
          >
            {siteConfig.phone}
          </a>
          <p className="mt-1 text-[13.5px] text-band-foreground/60">
            {siteConfig.hours.weekdays}
          </p>
        </Reveal>

        <Reveal delay={120}>
          <dl className="flex flex-col gap-4 border-t border-band-foreground/12 pt-6 text-[15px]">
              ...
              <div key={loc.id} className="flex gap-4">
                ...
                <dd>
                  <a
                    ...
                    className="text-band-foreground/85 transition-colors hover:text-band-foreground hover:underline"
                  >
                    {loc.address}
                  </a>
                </dd>
            ...
            <div className="flex gap-4">
              ...
              <dd>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 font-semibold text-band-foreground/85 transition-colors hover:text-band-foreground hover:underline"
                >
